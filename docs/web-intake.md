...
Open <http://127.0.0.1:1420>. Trunk hot-reloads the Leptos/WASM frontend and proxies `/api` to Axum on port 3000. `desktop-dev` remains unchanged and can be run independently.
